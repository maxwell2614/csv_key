...
df1.insert(loc=idx,column='key1', value=new_col)

df1['BIRTH_DAY']=df1['BIRTH_DAY'].astype(str)
df1['BIRTH_MONTH']=df1['BIRTH_MONTH'].astype(str)
df1['BIRTH_YEAR']=df1['BIRTH_YEAR'].astype(str)

df1['key1'] = df1.PATRONYMIC_NAME_CYR.str[:3]+df1.FIRST_NAME_CYR.str[:3]+df1.BIRTH_DAY+df1.BIRTH_MONTH+df1.BIRTH_YEAR
